    ...
    <Container maxWidth={"lg"} sx={{ my: "40px" }}>
      ...
      >
        ...
        >
          ...
          >
            Support our mission to bring positive change to people’s lives. Your
            donation helps us provide essential support, resources, and hope to
            those in need. Every contribution, big or small, makes a real
            difference.
          </MotionTypography>
          <MotionBox
            initial={{ y: -50, opacity: 0 }}
          ...
          {aboutToggle === "history" && (
            ...
            >
              <Typography sx={{ color: "#4e4e4e" }}>
                Our journey began with a simple goal: to help people in need and
                create lasting positive change through collective support.
              </Typography>
              <MotionBox
              ...
              >
                ...
                <Typography sx={{ color: "#4e4e4e" }}>
                  Grew through community trust and support
                </Typography>
              </MotionBox>
              <MotionBox
                sx={{ display: "flex", alignItems: "center", gap: "5px" }}
          ...
          {aboutToggle === "mission" && (
            ...
            >
              <Typography sx={{ color: "#4e4e4e" }}>
                Our mission is to support those in need, empower communities,
                and create positive, lasting impact through meaningful action.
              </Typography>
              <MotionBox
                sx={{ display: "flex", alignItems: "center", gap: "5px" }}
              >
                ...
                <Typography sx={{ color: "#4e4e4e" }}>
                  Provide essential help and resources
                </Typography>
              </MotionBox>
              <MotionBox
                sx={{ display: "flex", alignItems: "center", gap: "5px" }}
          ...
          {aboutToggle === "vission" && (
            ...
            >
              <Typography sx={{ color: "#4e4e4e" }}>
                Our vision is a world where everyone has access to support,
              ...
              >
                ...
                <Typography sx={{ color: "#4e4e4e" }}>
                  Build a more caring and inclusive society
                </Typography>
              </MotionBox>
              <MotionBox
                sx={{ display: "flex", alignItems: "center", gap: "5px" }}
              ...
              >
                ...
                <Typography sx={{ color: "#4e4e4e" }}>
                  Create lasting positive change worldwide
                </Typography>
              </MotionBox>
            </MotionStack>
          )}
