...
const DonateModal = ({ open, handleOpen, handleClose }: DI) => {
  ...
  const [
    bikashPayment,
    { isLoading: bkashLoading, isSuccess: bkashPaySuccess, error: bkashError },
  ] = useBikashPaymentMutation();
  // SSLCommerz Payment RKTQuery
  const [
    sslCommerzPayment,
    { isLoading: sslLoading, isSuccess: sslSuccess, error: sslError },
  ] = useSslCommerzPaymentMutation();
    ...
    >
      <Box sx={style}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            <Box>
              <Typography sx={{ py: "10px" }} fontSize={"20px"}>
              ...
              <Box sx={{ width: "100%" }}>
                ...
                >
                  <TextField
                    ...
                    helperText={
                      !!errors.phone_number &&
                      "Mobile number minimum and maximum 11 digits"
                    }
                  />
                  <TextField
                ...
                >
                  ...
                  >
                    <img
                      className="w-30 h-10"
                      src="/Campaign/sslcommerz.png"
                      alt=""
                    />
                  </Box>
                </Stack>
                {paymentError && (
                  <Typography color="#c1121f">
