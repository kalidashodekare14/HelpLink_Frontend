...
} from "@/state/services/receiverService/receiverService";
...
const HelpRquest = () => {
  ...
  const {
    ...
    setDistrict,
    setUpazila,
  } = useBDLocationRequest();
  // Session data
  const { data: session } = useSession();
  // Help request mutation
  const [helpRequest, { isSuccess, isLoading, error }] =
    useHelpRequestMutation();
  // Loading state
  ...
  const [
    campaignUploadImages,
    {
      isSuccess: campaignUploadSuccess,
      isLoading: campaignUploadLoading,
      error: campaignUploadError,
    },
  ] = useCampaignUploadImagesMutation();
  // Image upload state
  ...
  const [imageValidationError, setImageValidationError] =
        ...
        >
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Typography sx={{ fontWeight: 700, my: 2 }}>Location</Typography>
              <Box
                sx={{
                  display: "flex",
                  flexDirection: { lg: "row", xs: "column" },
          ...
          <Box
            ...
            borderRadius={5}
          >
            <Typography sx={{ fontSize: "20px", py: "5px" }}>
              Upload Image
            </Typography>
            <Box
              onClick={() =>
            ...
            >
              {imageValidationError && (
                <Typography
                  sx={{ fontSize: "16px", fontWeight: "400", color: "#c1121f" }}
                >
